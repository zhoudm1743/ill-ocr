...
```bash
docker cp /opt/paddle-ocr/main.py ill-ocr:/app/main.py
docker cp /opt/paddle-ocr/response.py ill-ocr:/app/response.py
docker cp /opt/paddle-ocr/idcard_parser.py ill-ocr:/app/idcard_parser.py
